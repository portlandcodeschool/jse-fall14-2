...
assert(name(47)==="Queen of Clubs", "Test s1 failed");
assert(isNaN(color("red")), 		"Test s2 failed");
assert(isNaN(suit("Two")),			"Test s3 failed");

// Failure Cases

assert(isNaN(cardID(true, 3)), 		"Test f1 failed");
assert(isNaN(rank(2, undefined)), 	"Test f2 failed");
assert(name(7)==="two of Clubs", 	"Test f3 failed");
