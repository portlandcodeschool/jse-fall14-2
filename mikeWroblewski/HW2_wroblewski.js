...
for (daysCounter = 0; daysCounter < 12; daysCounter++) {
   
  song += "On the " + days[daysCounter] + " day of Christmas" + "\n" + "My true love gave to me:" + "\n\n";
    ...
    if (daysCounter == 0) {  
      ...
      for (var decCounter = daysCounter; decCounter >= 0; decCounter--) {
      
        song += verses[decCounter] + "\n\n";
...
(Please note: Problem 5 is the most important one in this homework, because variations of it will recur in several later homeworks.  The cleaner your code is now, the easier it will be to modify later.)
